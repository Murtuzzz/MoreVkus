...
//        // Add a basket button to the navigation bar
//        let basketBarButton = UIBarButtonItem(
//            image: UIImage(systemName: "basket"),
//            style: .plain,
//            target: self,
//            action: #selector(basketAction)
//        )
...
//            historyCollection.heightAnchor.constraint(equalToConstant: 88),
